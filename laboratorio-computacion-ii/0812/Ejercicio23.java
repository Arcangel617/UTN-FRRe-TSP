...
* por el más pequeño, los números naturales que hay entre ambos, cuenta cuantos hay,
* cuenta cuantos de ellos son pares y calcula la suma de los impares.
*
...
public class Ejercicio23 {
	public static void main(String[] args) {
		...
		try {
			...
			if ((men < 1) && (may <= 1)) {
				throw new LowerThanException("No hay números naturales en el intervalo ("+ men +";"+ may +")");
			}

			System.out.print("Números naturales entre " + men + " y " + may +": ");
